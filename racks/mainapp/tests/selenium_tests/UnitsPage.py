...
class UnitsPage():
    ...
    def __init__(self, driver):
        self.driver = driver
        self.first_device_xpath = Locators.first_device_xpath
        self.second_device_xpath = Locators.second_device_xpath
    ...
    def open_first_device(self):
        self.driver.find_element_by_xpath(self.first_device_xpath).click()

    def open_second_device(self):
        self.driver.find_element_by_xpath(self.second_device_xpath).click()
