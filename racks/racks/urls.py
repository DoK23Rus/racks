...
urlpatterns = [
    ...
    path('units_print/<int:pk>/<str:side>', units_print_view, name='units_print'),
    ...
    path('building_upd/<int:pk>/<int:site_id>', building_upd_view, name='building_upd'),
    path('building_del/<int:pk>/delete', building_del_view, name='building_del'),
    path('room_add/<int:pk>', room_add_view, name='room_add'),
    path('room_upd/<int:pk>/<int:building_id>', room_upd_view, name='room_upd'),
