    ...
    async downloadDevices() {
      ...
      itemsNotFormatted.forEach((item) => {
        itemsFormatted.push({
          ...
          ip: item.ip ? item.ip : '',
          device_stack: 'http://127.0.0.1:8080/device/' + (item.device_stack ? item.device_stack : ''),
          ...
          link_to_device: 'http://127.0.0.1:8080/device/' + item.id,
    ...
    async downloadRacks() {
      ...
      itemsNotFormatted.forEach((item) => {
        itemsFormatted.push({
          ...
          link_to_rack: 'http://127.0.0.1:8080/rack/' + item.id,
          room_name: item.room_name,
          building_name: item.building_name,
          site_name: item.site_name,
          department_name: item.department_name,
